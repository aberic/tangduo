...
public class Bm25ToolsTests {
    ...
    void ik1() {
        ...
        contents.add(text14);
        contents.add(text15);
        contents.add(noiseText1);
        contents.add(noiseText2);
        contents.add(noiseText3);
        contents.add(noiseText4);
        contents.add(noiseText5);
        contents.add(noiseText6);
        contents.add(noiseText7);
        ...
        contents.forEach(s -> valueWithSegList.add(new DocSearchResponseVO(SHA256Tools.sha256(s), s, HanlpTools.seg(s))));
